    ...
    <div className="flex flex-col gap-y-4">
      {groups.map(({ key, groups }) => (
        <div key={key} className="flex flex-col gap-y-2">
          ...
          {groups.map((key) => (
            <div key={key} role="listitem" data-type="issue-skeleton" className={clsx("bg-card relative flex w-full flex-col gap-1 rounded-lg p-1", "border-card border")}>
              ...
              <div className="flex justify-between gap-x-2">
                ...
                <div>
                  <div role="listitem" data-type="timer-skeleton" className="flex items-center gap-x-3">
