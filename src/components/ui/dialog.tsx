...
function DialogPortal({ ...props }: DialogPrimitive.Portal.Props) {
  return <DialogPrimitive.Portal data-slot="dialog-portal" container={document.getElementById("redmine-time-tracking-shadow-host")?.shadowRoot} {...props} />;
}
...
function DialogTitle({ className, ...props }: DialogPrimitive.Title.Props) {
  return <DialogPrimitive.Title data-slot="dialog-title" className={cn("mb-1 text-lg leading-none font-medium", className)} {...props} />;
}
