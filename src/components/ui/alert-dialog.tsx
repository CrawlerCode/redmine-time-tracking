...
function AlertDialogPortal({ ...props }: AlertDialogPrimitive.Portal.Props) {
  return <AlertDialogPrimitive.Portal data-slot="alert-dialog-portal" container={document.getElementById("redmine-time-tracking-shadow-host")?.shadowRoot} {...props} />;
}
    ...
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Popup
        ...
        className={cn(
          ...
          "min-w-[18.5rem] data-[size=default]:max-w-[calc(100%-2rem)]",
          className
        )}
        {...props}
      />
