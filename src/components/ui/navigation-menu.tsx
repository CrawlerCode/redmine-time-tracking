...
function NavigationMenu({
  ...
  return (
    <NavigationMenuPrimitive.Root data-slot="navigation-menu" data-viewport={viewport} className={cn("group/navigation-menu relative flex max-w-max flex-1 items-center p-1.5", className)} {...props}>
      {children}
