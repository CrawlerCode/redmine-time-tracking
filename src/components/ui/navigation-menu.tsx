...
function NavigationMenuLink({ className, ...props }: NavigationMenuPrimitive.Link.Props) {
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        "hover:bg-primary/10 focus:bg-primary/10 focus-visible:ring-ring/50 data-active:bg-primary/10 data-active:text-primary data-active:focus:bg-primary/10 flex items-center gap-2 rounded-lg p-2 text-sm transition-all outline-none focus-visible:ring-3 focus-visible:outline-1 in-data-[slot=navigation-menu-content]:rounded-md data-active:font-medium [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    />
