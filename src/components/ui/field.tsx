...
function FieldLabel({ className, required, children, ...props }: React.ComponentProps<typeof Label> & { required?: boolean }) {
  return (
    <Label
      ...
      className={cn(
        "group/field-label peer/field-label group-data-[invalid=true]/field:text-destructive flex w-fit gap-2 truncate leading-snug group-data-[disabled=true]/field:opacity-50",
