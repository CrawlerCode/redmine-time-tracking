...
export const useSuspenseRedmineIssues = (options: Parameters<typeof redmineIssuesQuery>[1], queryOptions?: Omit<ReturnType<typeof redmineIssuesQuery>, "queryKey" | "queryFn">) => {
